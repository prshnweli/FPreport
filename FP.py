...
def goog(sc, sheet):
    ...
    # Formulas
    wks.update_value('C3', '=ROUND(AVERAGEIFS(O3:O999, L3:L999, 1),2)') # Grade 1 FALL
    wks.update_value('D3', '=ROUND(AVERAGEIFS(O3:O999, L3:L999, 2),2)') # Grade 2 FALL
    wks.update_value('E3', '=ROUND(AVERAGEIFS(O3:O999, L3:L999, 3),2)') # Grade 3 FALL
    wks.update_value('F3', '=ROUND(AVERAGEIFS(O3:O999, L3:L999, 4),2)') # Grade 4 FALL
    wks.update_value('G3', '=ROUND(AVERAGEIFS(O3:O999, L3:L999, 5),2)') # Grade 5 FALL

    wks.update_value('B4', '=ROUND(AVERAGEIFS(X3:W999, U3:T999, 0),2)') # Grade 0 WINTER
    wks.update_value('C4', '=ROUND(AVERAGEIFS(X3:W999, U3:T999, 1),2)') # Grade 1 WINTER
    wks.update_value('D4', '=ROUND(AVERAGEIFS(X3:W999, U3:T999, 2),2)') # Grade 2 WINTER
    wks.update_value('E4', '=ROUND(AVERAGEIFS(X3:W999, U3:T999, 3),2)') # Grade 3 WINTER
    wks.update_value('F4', '=ROUND(AVERAGEIFS(X3:W999, U3:T999, 4),2)') # Grade 4 WINTER
    wks.update_value('G4', '=ROUND(AVERAGEIFS(X3:W999, U3:T999, 5),2)') # Grade 5 WINTER
    ...
    wks.update_value('C6', '=ROUND(COUNTIFS(U3:T999, 1, X3:W999, ">=1.5")/COUNTIF(U3:T999, 1),4)') # Grade 0 At Grade Level
    wks.update_value('D6', '=ROUND(COUNTIFS(U3:T999, 2, X3:W999, ">=2.6")/COUNTIF(U3:T999, 2),4)') # Grade 0 At Grade Level
    wks.update_value('E6', '=ROUND(COUNTIFS(U3:T999, 3, X3:W999, ">=3.6")/COUNTIF(U3:T999, 3),4)') # Grade 0 At Grade Level
    wks.update_value('F6', '=ROUND(COUNTIFS(U3:T999, 4, X3:W999, ">=4.6")/COUNTIF(U3:T999, 4),4)') # Grade 0 At Grade Level
    wks.update_value('G6', '=ROUND(COUNTIFS(U3:T999, 5, X3:W999, ">=5.6")/COUNTIF(U3:T999, 5),4)') # Grade 0 At Grade Level
